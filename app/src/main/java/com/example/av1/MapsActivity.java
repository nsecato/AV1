        ...
        botaoGerarRota.setOnClickListener(v -> {
            ...
            obterIdLugarDePredicao(nomeLocalChegada, idLocalChegada -> obterLatLngDeIdLugar(idLocalChegada, latLngChegada -> {
                ...
                if(mapaGoogle != null && posicaoPartida != null && posicaoChegada != null) {
                    ...
                    veiculo.atualizarDestino(posicaoChegada); //Passa o destino a classe usuário para a reconciliação de dados do percurso
                    veiculo.atribuirRota(rota); //Passa o objeto rota para acessar os métodos de recuperação das durações e distancias dos fluxos
